...
/// Used to configure how the [CustomPopupMenuButton] positions its popup menu.
...
/// [CustomPopupMenuItem]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
  ...
  Widget build(BuildContext context) {
    ...
    return MergeSemantics(
      child: Semantics(
        ...
        button: true,
        child: InkWell(
          hoverColor: widget.hoverColor ?? context.colors.textFieldBorderColor,
          onTap: () {
            if (widget.enabled) handleTap();
          },
...
///  * [CustomPopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends CustomPopupMenuItem<T> {
          ...
          child: InkWell(
            ...
            child: Container(
              decoration: BoxDecoration(
                border: focused ? widget.focusedBorder : widget.unfocusedBorder,
